"""Resolução do diretório de assets estáticos (ícones, logo, beep) da GUI Qt.
...
LOGO_FILENAME = "logo.png"                         # logo exibido na barra de conexão
...
__all__ = ["ASSETS_DIR", "ICON_FILENAME", "ICON_PNG_FILENAME", "LOGO_FILENAME", "BEEP_FILENAME"]
